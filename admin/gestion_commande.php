...
//------ TRAITEMENT PHP ------//
// Si l'utilisateur n'est pas admin, on le redirige vers la connexion
if (!userAdmin()) {
    header("location:../connexion.php");
}

// Si un utilisateur a effectué une commande
if (isset($_GET['id_commande']) && !empty($_GET['id_commande'])) {
    ...
    $contenu .= '<div class="erreur">Aucune commande n\'a été effectuée.</div>';
}
